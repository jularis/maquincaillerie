        ...
        <div class="flex-1 overflow-hidden">
            <div class="flex h-full transition-transform duration-500 ease-in-out"
                ...
                <div class="w-full h-full shrink-0 grid grid-cols-1 md:grid-cols-2 gap-8 items-start pt-6 pb-2">
                    ...
                    {{-- Infos --}}
                    <div class="flex flex-col gap-3 justify-center pt-24" style="margin-top: 100px;">
                        ...
                        <a href="{{ route('products.show', $product->slug) }}"
                           ...
                           class="inline-flex items-center gap-1.5 bg-orange hover:bg-orange/90 text-white font-bold px-4 py-2.5 rounded-xl transition-colors text-sm">
                            Voir le produit
...
<section class="bg-gradient-to-br from-navy via-navy-light to-[#2a4890] text-white relative overflow-hidden">
    ...
    <div class="max-w-screen-xl mx-auto px-4 pt-12 pb-8 relative flex flex-col items-center">
        ...
        {{-- Title --}}
{{-- 2 hero cards --}}
        <div class="grid grid-cols-1 md:grid-cols-2 gap-4 max-w-5xl mx-auto w-full">
