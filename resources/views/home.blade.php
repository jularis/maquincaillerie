        ...
        <div class="grid lg:grid-cols-2 gap-12 items-center">
            ...
            <div class="bg-navy rounded-2xl p-8 text-white" id="contact">
                ...
                <div class="space-y-4 mb-6">
                    <a href="tel:+2252735958998" class="flex items-center gap-4 bg-white/10 rounded-xl p-4 hover:bg-white/20 transition-colors group">
                        ...
                        <div>
                            <div class="text-xs text-blue-300">+225 27 35 95 89 98 / 07 69 62 26 44 / 05 56 65 13 55</div>
                            <div class="font-bold group-hover:text-orange transition-colors">Appelez-nous</div>
                        </div>
                    </a>

                    <a href="mailto:commerciale@cleanenergyservices.net" class="flex items-center gap-4 bg-white/10 rounded-xl p-4 hover:bg-white/20 transition-colors group">
                        <div class="w-10 h-10 bg-orange rounded-xl flex items-center justify-center shrink-0">
                            <svg class="w-5 h-5 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z"/></svg>
                        </div>
                        <div>
                            <div class="text-xs text-blue-300">Réponse sous 24h</div>
                            <div class="font-bold group-hover:text-orange transition-colors">commerciale@cleanenergyservices.net</div>
                        </div>
                    </a>
                </div>
